      ...
      <div class="container">
        <table class="table table-striped">
          <thead>
            <tr>
              <th scope="col">#</th>
              <th scope="col">Brand <a href="add_brand.php" class="btn btn-success"><i class="fas fa-plus"></i></a></th>
              <th scope="col">Models <a href="add_model.php" class="btn btn-success"><i class="fas fa-plus"></i></a>
              </th>
            </tr>
          </thead>
          <tbody>
